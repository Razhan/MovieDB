...
package com.razhan.ava.data.repository;

import com.razhan.ava.data.entity.Identifiable;
import com.razhan.ava.data.repository.datasource.paginated.Page;
import com.razhan.ava.data.repository.datasource.paginated.PaginatedCacheDataSource;
import com.razhan.ava.data.repository.datasource.paginated.PaginatedCollection;
import com.razhan.ava.data.repository.datasource.paginated.PaginatedReadableDataSource;
import com.razhan.ava.data.repository.policy.ReadPolicy;
import com.razhan.ava.domain.repository.AvaRepository;
...
/**
 * Paginated version of {@link AvaRepository}. It adds methods for retrieving paginated data
 */
public class PaginatedAvaRepository<K, V extends Identifiable<K>> extends AvaRepository<K, V> {

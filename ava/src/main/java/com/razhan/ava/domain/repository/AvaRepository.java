...
package com.razhan.ava.domain.repository;


import com.razhan.ava.data.entity.Identifiable;
import com.razhan.ava.data.repository.datasource.CacheDataSource;
import com.razhan.ava.data.repository.datasource.ReadableDataSource;
import com.razhan.ava.data.repository.datasource.WriteableDataSource;
import com.razhan.ava.data.repository.policy.ReadPolicy;
import com.razhan.ava.data.repository.policy.WritePolicy;
 ...
 */
public class AvaRepository<K, V extends Identifiable<K>>
